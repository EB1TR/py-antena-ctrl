...
function onMessageArrived(message) {
  ...
  $('input[name="s801c"]').val(json.segmentos['80']['1']['cominzo'])
  ...
  $('input[name="s802c"]').val(json.segmentos['80']['2']['cominzo'])
  ...
  $('input[name="s803c"]').val(json.segmentos['80']['3']['cominzo'])
  ...
  $('input[name="s804c"]').val(json.segmentos['80']['4']['cominzo'])
  ...
  $('input[name="s1601c"]').val(json.segmentos['160']['1']['cominzo'])
  ...
  $('input[name="s1602c"]').val(json.segmentos['160']['2']['cominzo'])
  ...
  $('input[name="s1603c"]').val(json.segmentos['160']['3']['cominzo'])
  ...
  $('input[name="s1604c"]').val(json.segmentos['160']['4']['cominzo'])
